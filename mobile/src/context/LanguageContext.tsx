...
const translations: Record<Language, Translations> = {
  en: {
    ...
    previewText:
      "Narendra Kirana delivers fresh groceries, daily essentials, and veggies straight to your doorstep at wholesale prices.",
    ...
    noOffersSub:
      "Check back later for fresh coupons and special grocery discounts!",
    expires: "Expires",
    ...
    chooseLanguageSubtitle:
      "Choose the language you prefer for browsing and ordering",
  ...
  te: {
    ...
    previewText:
      "నరేంద్ర కిరాణా తాజా కూరగాయలు, నిత్యావసర సరుకులను హోల్‌సేల్ ధరలకే మీ ఇంటి వద్దకు అందిస్తుంది.",
    ...
    noOffersSub:
      "తాజా కూపన్లు మరియు కిరాణా తగ్గింపుల కోసం తర్వాత మళ్లీ చూడండి!",
    expires: "గడువు",
