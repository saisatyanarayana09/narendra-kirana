...
export function AccountSettingsScreen({
  ...
  const handleSaveProfile = async () => {
    ...
    if (trimmedDob) {
      ...
      if (!dobPattern.test(trimmedDob)) {
        setDobError(
          "Date of birth must be in YYYY-MM-DD format (e.g. 1995-08-15).",
        );
        Alert.alert(
          "Validation Error",
          "Date of birth must be in YYYY-MM-DD format (e.g. 1995-08-15).",
      ...
      if (
        ...
        Alert.alert(
          "Validation Error",
          "Please enter a valid past calendar date in YYYY-MM-DD format (e.g. 1995-08-15).",
        );
        return;
      }
    }
  ...
  const handleRequestDeletion = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        err.response?.data?.error || "Failed to request deletion.",
      );
    } finally {
      ...
      >
        ...
        <View style={styles.guestStateContainer}>
          ...
          <Text style={[styles.guestSubtitle, { color: colors.textSecondary }]}>
            Please sign in to update your profile name, date of birth, and
      ...
      >
        ...
        >
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={[
                  ...
                  Boolean(dobError) && styles.textInputError,
                ]}
                value={dob}
                onChangeText={(val) => {
                  setDob(val);
              ...
              >
                Format: YYYY-MM-DD (e.g. 1995-08-15)
              </Text>
              {Boolean(dobError) && (
          ...
          >
            ...
            <Text
              style={[styles.dangerSubtitle, isDark && { color: "#FB7185" }]}
            >
            ...
            {deleteRequested ? (
              ...
              >
                ...
                <Text
                  style={[
                    styles.deletionPendingDesc,
                    isDark && { color: "#FDE68A" },
                  ]}
                >
                  Your deletion request is currently being reviewed by store
                  management. You will be logged out once approved.
                </Text>
              </View>
            ) : showDeletePrompt ? (
              <View
                style={[
                  styles.deletePromptCard,
                  {
              ...
              >
                <Text
                  style={[styles.deletePromptLabel, { color: colors.text }]}
                >
