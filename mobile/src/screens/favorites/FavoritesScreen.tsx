      ...
      >
        ...
        <View style={styles.guestStateContainer}>
          ...
          <Text style={[styles.guestSubtitle, { color: colors.textSecondary }]}>
            Save your favorite grocery items, track price drops, and add them
            directly to cart.
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.emptyContainer}>
          <View
            style={[
              ...
              isDark && { backgroundColor: "rgba(239, 68, 68, 0.15)" },
            ]}
          >
            <Feather name="heart" size={44} color="#E11D48" />
          </View>
          ...
          <Text style={[styles.emptySubtitle, { color: colors.textSecondary }]}>
            Keep track of the products you love by clicking the heart icon on
            any product.
          </Text>
          <TouchableOpacity
