...
if "Edit2" not in content:
    content = content.replace("Trash2, Plus, X }", "Trash2, Plus, X, Edit2 }")
    content = content.replace("Trash2, Plus, X,", "Trash2, Plus, X, Edit2,")
    content = content.replace("Trash2, Plus,", "Trash2, Plus, X, Edit2,")

new_code = """import { useEffect, useState } from 'react';
