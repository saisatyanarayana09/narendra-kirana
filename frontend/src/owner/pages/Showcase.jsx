    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          {savingOrder && (
            <div className="flex items-center gap-2 text-sm text-indigo-600 font-semibold bg-indigo-50 px-3 py-2 rounded-xl">
              <Loader2 className="w-4 h-4 animate-spin" />
              Saving layout…
            </div>
          )}
          <button onClick={handleAddSection} className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition">
            ...
            >
              {sections.length === 0 && (
                <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-300">
                  ...
                  <button onClick={handleAddSection} className="px-4 py-2 bg-indigo-50 text-indigo-600 font-bold rounded-xl hover:bg-indigo-100">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 px-5 py-4 bg-gray-50 border-b border-gray-100">
                        ...
                        <div className="flex-1 flex items-center gap-3">
                          ...
                          <button onClick={() => { setRenamingSection(section); setRenameTitle(section.title); }} className="text-gray-400 hover:text-indigo-600 p-1">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl p-6">
            ...
            <input 
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 mb-4" 
            />
            <div className="flex justify-end gap-2">
              ...
              <button onClick={submitRename} className="px-4 py-2 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl">Save</button>
            </div>
          </div>
        </div>
      )}
