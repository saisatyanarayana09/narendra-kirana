...
pattern = re.compile(r'   <div>\s*<label className="block text-sm font-bold text-slate-700 mb-1\.5">SKU / Barcode</label>\s*<input type="text" value=\{formData\.sku\}[\s\S]*?/>\s*</div>')
